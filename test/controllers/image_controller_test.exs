defmodule AgedThunder.ImageControllerTest do
  use AgedThunder.ConnCase

  alias AgedThunder.Image
  @upload %Plug.Upload{path: Path.relative_to_cwd("test/files/sfo.jpg"), filename: "sfo.jpg", content_type: "image/jpg"}
  @valid_attrs %{attachment: @upload, desc: "some content", name: "some content"}
  @invalid_attrs %{}
  ...
  test "creates resource and redirects when data is valid", %{conn: conn} do
    ...
    assert Repo.get_by(Image, Map.drop(@valid_attrs, [:attachment]))
  end
